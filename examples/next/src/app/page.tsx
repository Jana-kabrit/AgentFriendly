...
export default function HomePage() {
  return (
    <main>
      ...
      <p>
        This page is served as clean, structured markdown to AI agents,
        and as a normal web page to human visitors.
      </p>
      ...
      <ul>
        ...
        <li>Exposes a machine-readable tool manifest at <code>/.well-known/agent.json</code></li>
